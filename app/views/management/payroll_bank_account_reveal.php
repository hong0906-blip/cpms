<?php
/**
 * Reveal one employee bank account after server-side permission check.
 * PHP 5.6 compatible.
 */
...
if (!cpms_can_view_company_payroll($user, $pdo)) {
    ...
    echo cpms_company_payroll_json_encode(array('ok' => false, 'message' => '계좌번호 조회 권한이 없습니다.'));
    exit;
}
...
$result = cpms_company_payroll_reveal_bank_account($year, $month, $employeeKey, $user);
