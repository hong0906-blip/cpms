...
$result = cpms_company_vehicle_delete($id, $user);
if (isset($_SESSION['_company_profit_cache'])) unset($_SESSION['_company_profit_cache']);
flash_set(!empty($result['ok']) ? 'success' : 'danger', isset($result['message']) ? (string)$result['message'] : '회사차량을 삭제하지 못했습니다.');
