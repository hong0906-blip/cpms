...
<div class="ah-wrap">
  <section class="ah-hero"><h2>현장별 비용 이상징후 탐지 결과</h2><p>저장된 입력 신뢰도와 비교자료에서 확인이 필요한 변화를 찾은 관리자용 참고 화면입니다.</p><div class="ah-links"><a class="ah-link" href="?r=admin%2Fai_anomaly_setup">이상징후 탐지 설정</a><a class="ah-link secondary" href="?r=admin%2Fai_reliability_history">입력 신뢰도 결과</a><a class="ah-link secondary" href="?r=admin%2Fai_forecast_history">기본 월말 예측 결과</a><a class="ah-link secondary" href="?r=admin%2Fai_snapshot_history">일일 스냅샷 이력</a></div></section>
