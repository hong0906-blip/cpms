...
<div class="eb-wrap">
  <section class="eb-hero"><h2>대표용 경영 브리핑</h2><p>저장된 최신 적자·원가율 위험분석 결과를 OpenAI가 대표가 읽기 쉬운 문장으로 설명합니다. PHP 계산결과가 원본이며 GPT 설명은 보조자료입니다.</p><div class="eb-links"><a class="eb-btn secondary" href="?r=admin%2Fai_ceo_index">CEO Index</a><a class="eb-btn secondary" href="?r=admin%2Fai_openai_setup">OpenAI 연결 설정</a><a class="eb-btn secondary" href="?r=admin%2Fai_profit_risk_history">적자·원가율 위험 결과</a></div></section>
