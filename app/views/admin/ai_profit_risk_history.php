...
<div class="prh-wrap">
  <section class="prh-hero"><h2>현장별 적자·원가율 위험분석 결과</h2><p>저장된 매출·스냅샷·월말 예측을 이용한 관리자용 관리 참고자료입니다.</p><div class="prh-links"><a class="prh-link" href="?r=admin%2Fai_profit_risk_setup">위험분석 설정</a><a class="prh-link secondary" href="?r=admin%2Fai_anomaly_history">이상징후 결과</a><a class="prh-link secondary" href="?r=admin%2Fai_reliability_history">입력 신뢰도 결과</a><a class="prh-link secondary" href="?r=admin%2Fai_forecast_history">월말 예측 결과</a></div></section>
