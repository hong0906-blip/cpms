...
try {
    if ($action === 'add_position_column') {
        ...
        $added = array(); $exists = array();
        $targets = array('position'=>'VARCHAR(20) NULL','hire_date'=>'DATE NULL','resign_date'=>'DATE NULL','monthly_regular_wage'=>'DECIMAL(15,2) NULL','leave_monthly_balance'=>'DECIMAL(6,2) NULL','leave_annual_balance'=>'DECIMAL(6,2) NULL','leave_half_balance'=>'DECIMAL(6,2) NULL','birth_date'=>'DATE NULL','employee_no'=>'VARCHAR(50) NULL','phone'=>'VARCHAR(50) NULL','work_location'=>'VARCHAR(100) NULL','signature_path'=>'VARCHAR(255) NULL','approval_can_be_site_manager'=>'TINYINT(1) NOT NULL DEFAULT 0','approval_can_be_team_leader'=>'TINYINT(1) NOT NULL DEFAULT 0','approval_can_be_gongmu_approver'=>'TINYINT(1) NOT NULL DEFAULT 0','approval_can_be_manage_approver'=>'TINYINT(1) NOT NULL DEFAULT 0','is_team_leader'=>'TINYINT(1) NOT NULL DEFAULT 0','team_leader_id'=>'INT NULL','google_chat_enabled'=>'TINYINT(1) NOT NULL DEFAULT 0','google_chat_user_name'=>'VARCHAR(190) NULL','google_chat_dm_space_name'=>'VARCHAR(255) NULL','photo_path'=>'VARCHAR(255) NULL');
