...
require_once __DIR__ . '/partials/monthly_cost_detail_helper.php';
...
<?php
$cpmsMonthlyCostDetailTriggerSelector = '.cpms-monthly-detail-trigger';
$cpmsMonthlyCostDetailDesktopOnly = false;
require __DIR__ . '/partials/monthly_cost_detail_modal.php';
?>
