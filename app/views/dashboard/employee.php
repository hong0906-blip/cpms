...
<div class='p-4 rounded-2xl bg-gray-50'><div class='text-gray-500'>오늘 날짜</div><div class='font-extrabold text-lg'><?php echo h($today_att);?></div></div>    
...
<div class='p-4 rounded-2xl bg-gray-50'><div class='text-gray-500'>오늘 출근 / 오늘 퇴근</div><div class='font-extrabold text-lg'><?php echo h($todayInState);?> / <?php echo h($todayOutState);?></div></div>
<div class='p-4 rounded-2xl bg-gray-50'><div class='text-gray-500'>출근 / 퇴근</div><div class='font-extrabold text-lg'><?php echo h(isset($todayRow['check_in'])&&$todayRow['check_in']?$todayRow['check_in']:'-');?> / <?php echo h(isset($todayRow['check_out'])&&$todayRow['check_out']?$todayRow['check_out']:'-');?></div></div>
<div class='p-4 rounded-2xl bg-blue-50'><div class='text-gray-500'>오늘 실제 체류시간</div><div class='font-extrabold text-lg text-blue-700'><?php echo attendance_hm(isset($todayRow['raw_minutes'])?(int)$todayRow['raw_minutes']:0);?></div></div>
...
<div class='p-4 rounded-2xl bg-gray-50'><div class='text-gray-500'>40시간 기준</div><div class='font-extrabold text-lg'><?php echo number_format(($weekWork/60)-40,2);?>h</div></div>
