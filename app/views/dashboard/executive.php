...
<div class="mb-4 flex flex-wrap items-center gap-2" role="tablist" aria-label="임원 대시보드 탭">
    ...
    <a href="<?php echo h(base_url()); ?>/?r=cost_change/approvals" class="cpms-exec-tab-btn px-4 py-2 rounded-xl border text-sm font-extrabold transition bg-blue-50 border-blue-200 text-blue-700">비용 변경 승인</a>
