...
.approval-paper table{width:100%;border-collapse:collapse}.approval-paper th,.approval-paper td{border:1px solid #111;padding:4px 6px;font-size:13px;vertical-align:middle}
...
.doc-input{border:0;border-bottom:1px solid #999;background:transparent;width:100%;font-size:13px}.doc-textarea{border:0;width:100%;min-height:66px}
