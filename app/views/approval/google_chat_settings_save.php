...
$pdo = Db::pdo();
$keys = array('google_chat_enabled','google_chat_service_account_json_path','google_chat_project_id','google_chat_bot_email','google_chat_oauth_scope','google_chat_impersonation_user','google_chat_public_base_url','google_chat_dm_auto_create_enabled');
