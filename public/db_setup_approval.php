...
$tables = array(
    'cpms_approval_documents' => "CREATE TABLE IF NOT EXISTS cpms_approval_documents (id INT AUTO_INCREMENT PRIMARY KEY, doc_type VARCHAR(20) NULL, title VARCHAR(255) NULL, content MEDIUMTEXT NULL, doc_status VARCHAR(20) NULL, current_step_order INT DEFAULT 1, created_by_id INT NULL, created_by_name VARCHAR(100) NULL, created_by_email VARCHAR(190) NULL, project_id INT NULL, completed_pdf_storage_type VARCHAR(30) NULL, completed_pdf_drive_file_id VARCHAR(128) NULL, completed_pdf_drive_folder_id VARCHAR(128) NULL, completed_pdf_drive_web_view_link TEXT NULL, completed_pdf_drive_web_content_link TEXT NULL, completed_pdf_year VARCHAR(4) NULL, completed_pdf_month VARCHAR(2) NULL, completed_pdf_year_folder_id VARCHAR(128) NULL, completed_pdf_type_folder_id VARCHAR(128) NULL, completed_pdf_month_folder_id VARCHAR(128) NULL, completed_pdf_name VARCHAR(255) NULL, completed_pdf_mime_type VARCHAR(190) NULL, completed_pdf_size BIGINT NULL, completed_pdf_uploaded_at DATETIME NULL, completed_pdf_upload_status VARCHAR(30) NULL, completed_pdf_upload_error TEXT NULL, completed_pdf_render_version INT NULL, delegate_level VARCHAR(20) NULL, reject_reason TEXT NULL, rejected_step VARCHAR(50) NULL, created_at DATETIME NULL, updated_at DATETIME NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
    ...
    'cpms_approval_files' => "CREATE TABLE IF NOT EXISTS cpms_approval_files (id INT AUTO_INCREMENT PRIMARY KEY, document_id INT NULL, original_name VARCHAR(255) NULL, saved_name VARCHAR(255) NULL, file_path VARCHAR(255) NULL, file_label VARCHAR(100) NULL, file_type VARCHAR(50) NULL, storage_type VARCHAR(30) NULL, drive_name VARCHAR(255) NULL, drive_file_id VARCHAR(128) NULL, drive_folder_id VARCHAR(128) NULL, drive_web_view_link TEXT NULL, drive_web_content_link TEXT NULL, document_year VARCHAR(4) NULL, document_month VARCHAR(2) NULL, drive_year_folder_id VARCHAR(128) NULL, drive_type_folder_id VARCHAR(128) NULL, drive_month_folder_id VARCHAR(128) NULL, mime_type VARCHAR(190) NULL, file_size BIGINT NULL, uploaded_by VARCHAR(190) NULL, uploaded_at DATETIME NULL, upload_status VARCHAR(30) NULL, drive_upload_error TEXT NULL, created_at DATETIME NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
