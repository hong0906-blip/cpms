...
try {
    ...
    $errorMessage=$e->getMessage(); $settings=array('enabled'=>false,'username'=>'','batch_size'=>100,'imap_host'=>'imap.naver.com','imap_port'=>993); $syncState=array(); $cacheStats=array('storage_writable'=>false,'total_messages'=>0,'cached_messages'=>0,'missing_messages'=>0,'legacy_messages'=>0,'cache_version'=>19); $indexStatus=array('version'=>0,'package_version'=>'','updated_at'=>'','item_count'=>0,'file_exists'=>false,'file_size'=>0,'writable'=>false); $cronInfo=array('url'=>'','header_name'=>'X-CPMS-Mail-Key','header_value'=>'');
}
PublicMailWebHelper::render('public_mail/settings',array(
    ...
    'cronInfo'=>$cronInfo,'cacheStats'=>$cacheStats,'indexStatus'=>$indexStatus,'packageVersion'=>'1.7.21','csrfToken'=>PublicMailWebHelper::csrfToken(),'flash'=>PublicMailWebHelper::pullFlash(),'errorMessage'=>$errorMessage
));
