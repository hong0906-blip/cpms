...
PublicMailWebHelper::render('public_mail/settings',array(
    ...
    'cronInfo'=>$cronInfo,'cacheStats'=>$cacheStats,'indexStatus'=>$indexStatus,'packageVersion'=>'1.7.12','csrfToken'=>PublicMailWebHelper::csrfToken(),'flash'=>PublicMailWebHelper::pullFlash(),'errorMessage'=>$errorMessage
));
