...
PublicMailWebHelper::render('public_mail/settings',array(
    ...
    'cronInfo'=>$cronInfo,'cacheStats'=>$cacheStats,'indexStatus'=>$indexStatus,'packageVersion'=>'1.7.6','csrfToken'=>PublicMailWebHelper::csrfToken(),'flash'=>PublicMailWebHelper::pullFlash(),'errorMessage'=>$errorMessage
));
